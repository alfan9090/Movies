...
import com.ahmadalfan.movieapp.databinding.ActivityTvAiringTodayBinding
...
class TvAiringTodayActivity : AppCompatActivity(), KodeinAware {
    ...
    private lateinit var binding: ActivityTvAiringTodayBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTvAiringTodayBinding.inflate(layoutInflater)
